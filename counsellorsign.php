        ...
        <div class="container1">
            ...
            <form class="contact1-form" action="lawyer.php" method="post">
                <div class="card-details">
                    ...
                    <div class="a2"><b>If you want voluntarily sign-up and provide Counselling support/advice to our
                        victims </b></div>

                    <div class="mt-4">
                        <h4><b>About Yourself: </b> </h4>
                        <div class="input-group card-box">
                            <p style="font-size: 19px;" name="y/n">Are you comfortable initially communicating with a client by answering a question via email ?</p>
                    ...
                    <div>
                        <h4><b> Description & Web Contact Information</b></h4>
                        ...
                        <div class="input-group card-box">
                            ...
                            <textarea id="desc" name="description" rows="8" cols="80" placeholder="Description"></textarea>
                        </div>
                    </div>
                </div>
